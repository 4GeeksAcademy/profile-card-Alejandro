    ...
    variables.country === null ? "País" : variables.country
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://twitter.com/${
              variables.twitter === null ? `x` : variables.twitter
            }"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${
              variables.github === null ? `midudev` : variables.github
            }"><i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/in/${
              variables.linkedin === null ? `midudev` : variables.linkedin
            }"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${
              variables.instagram === null ? `midudev` : variables.instagram
